...
int test_feature()
{
	...
	for (size_t i = 0; i < devices.size(); i++)
	{
...

		{
			...
			array<_type, _rank> src1(e1, device1.default_view);
			array<_type, _rank> src2(e1, device2.default_view);
		...
		{
			const int rank = 1;
			array<_type, rank> src1(edata[0], device1.default_view);
			array<_type, rank> src2(edata[0], device2.default_view);
		...
		{
			const int rank = 2;
			array<_type, rank> src1(edata[0], edata[1], device1.default_view);
			array<_type, rank> src2(edata[0], edata[1], device2.default_view);
		...
		{
			const int rank = 3;
			array<_type, rank> src1(edata[0], edata[1], edata[2], device1.default_view);
			array<_type, rank> src2(edata[0], edata[1], edata[2], device2.default_view);
...
int test_feature()
{
	...
	for (size_t i = 0; i < devices.size(); i++)
	{
		...
		{
			extent<_rank> e1(edata);
			array<double, _rank> src1(e1, device1.default_view);
			array<double, _rank> src2(e1, device2.default_view);
		...
		{
			const int rank = 1;
			array<double, rank> src1(edata[0], device1.default_view);
			array<double, rank> src2(edata[0], device2.default_view);
		...
		{
			const int rank = 2;
			array<double, rank> src1(edata[0], edata[1], device1.default_view);
			array<double, rank> src2(edata[0], edata[1], device2.default_view);
		...
		{
			const int rank = 3;
			array<double, rank> src1(edata[0], edata[1], edata[2], device1.default_view);
			array<double, rank> src2(edata[0], edata[1], edata[2], device2.default_view);
