...
runall_result test_main()
{
    ...
    result &= REPORT_RESULT(run_simple_p_f_e(acc1.default_view));
    result &= REPORT_RESULT(run_simple_p_f_e(acc2.default_view));
    result &= REPORT_RESULT(run_simple_p_f_e(acc3.default_view));
