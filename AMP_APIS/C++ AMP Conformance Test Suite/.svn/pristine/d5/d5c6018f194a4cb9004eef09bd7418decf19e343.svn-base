...
bool test_feature()
{
    ...
    array<_type, _rank> arr(e1, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_1D_ACCLVW_
    array<_type, 1> arr(10, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_2D_ACCLVW_
    array<_type, 2> arr(10, 10, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_3D_ACCLVW_
    array<_type, 3> arr(10, 10, 10, accelerator().default_view);
#endif
    ...
    array<_type, _rank> arr(e1, accelerator().default_view, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_1D_ACCLVW_STAGING_
    array<_type, 1> arr(10, accelerator().default_view, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_2D_ACCLVW_STAGING_
    array<_type, 2> arr(10, 10, accelerator().default_view, accelerator().default_view);
#endif

#ifdef _CONSTRUCTOR_3D_ACCLVW_STAGING_
    array<_type, 3> arr(10, 10, 10, accelerator().default_view, accelerator().default_view);
#endif
