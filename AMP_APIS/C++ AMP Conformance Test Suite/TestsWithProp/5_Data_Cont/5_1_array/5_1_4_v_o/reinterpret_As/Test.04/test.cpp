...
runall_result test_main()
{
    ...
    int expected_size = arr_rbg.extent.size() * sizeof(Foo) / sizeof(float);
    Log() << "Expected size: " << expected_size << " actual: " << av_float.extent[0] << std::endl;
    if (av_float.extent[0] != expected_size)
    {
        return runall_fail;
    }
