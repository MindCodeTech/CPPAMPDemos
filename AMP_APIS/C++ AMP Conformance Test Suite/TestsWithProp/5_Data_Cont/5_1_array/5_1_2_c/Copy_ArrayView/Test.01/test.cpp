...
bool test_feature()
{
	...
	{
		bool pass = test_array_copy_constructors_with_array_view<_type, _rank,accelerator_view>((_gpu_device).default_view) &&
    ...
    {
        bool pass = test_array_copy_constructors_with_array_view<_type, _rank, accelerator_view>((_gpu_device).default_view, _cpu_device.default_view) &&
