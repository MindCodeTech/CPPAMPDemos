...
public:
	StagingArrayToStagingArrayTests()
	{
		...
		if(gpu_acc1.supports_cpu_shared_memory)
		{
			WLog() << "Accelerator " << gpu_acc1.description << " supports zero copy" << std::endl;
		...
		if(gpu_acc2.supports_cpu_shared_memory)
		{
			WLog() << "Accelerator " << gpu_acc2.description << " supports zero copy" << std::endl;
	...
	{
		accelerator_view cpu_av1 = cpu_acc.default_view;
		accelerator_view stg_arr_av1 = gpu_acc1.default_view;

		accelerator_view cpu_av2 = cpu_acc.default_view;
		accelerator_view stg_arr_av2 = gpu_acc2.default_view;
