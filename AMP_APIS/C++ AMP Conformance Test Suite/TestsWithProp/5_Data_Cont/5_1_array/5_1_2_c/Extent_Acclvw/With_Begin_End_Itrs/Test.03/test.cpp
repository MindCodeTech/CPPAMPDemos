...
bool test_feature()
{
    ...
    {
        bool pass = test_feature_itr<_type, _rank, _D0, _D1, accelerator_view>(data, data+(_D0*_D1), (_gpu_device).default_view);
    ...
    {
        bool pass = test_feature_itr<_type, _rank, _D0, _D1, accelerator_view>(data, (_gpu_device).default_view);
