...
bool test_feature()
{
    ...
    {
        bool pass = test_feature_staging_itr<_type, _rank, accelerator_view>(e1, data.begin(), data.end(), (_gpu_device).default_view, _cpu_device.default_view) &&
    ...
    {
        bool pass = test_feature_staging_itr<_type, _rank, accelerator_view>(e1, data.begin(), (_gpu_device).default_view, _cpu_device.default_view) &&
