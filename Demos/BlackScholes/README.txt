...
Black-Scholes model is derived from a partial differential equation which is used to track pricing of the option over time. This sample is implementing European options and its formula is mentioned here - http://en.wikipedia.org/wiki/Black%E2%80%93Scholes#Black.E2.80.93Scholes_formula.
