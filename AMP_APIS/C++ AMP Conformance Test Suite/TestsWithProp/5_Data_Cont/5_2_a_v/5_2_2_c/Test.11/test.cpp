...
runall_result test_main()
{
    ...
    parallel_for_each(acc_view, av1.extent, [=](index<3> idx) restrict(amp)
    {
        av2[idx] = av1[idx] + 1;
    });
