...
public:
	StagingArrayToStagingArrayTests()
	{
		...
		{
			WLog() << "Accelerator " << gpu_acc.description << " supports zero copy" << std::endl;
	...
	bool CpuAccViewToCpuAccView()
	{
		...
		accelerator_view stg_arr_av1 = gpu_acc.default_view;

		accelerator_view cpu_av2 = cpu_acc.default_view;
		accelerator_view stg_arr_av2 = gpu_acc.default_view;
