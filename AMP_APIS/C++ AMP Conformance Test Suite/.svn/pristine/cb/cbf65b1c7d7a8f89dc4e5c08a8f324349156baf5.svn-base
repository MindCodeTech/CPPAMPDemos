...
void RunMyKernel(vector<type> &a, vector<type> &b, vector<type> &c, vector<type> &fa, vector<type> &fb, vector<type> &fc, vector<int> &flag, accelerator_view av)
{
    ...
    parallel_for_each(a_a.extent.template tile<BLOCK_SIZE_1D, BLOCK_SIZE_1D, BLOCK_SIZE_1D>(), [&, b1, b2, b3, b4] (tiled_index<BLOCK_SIZE_1D, BLOCK_SIZE_1D, BLOCK_SIZE_1D> idx) __GPU_ONLY {
