...
runall_result test_main()
{
    ...
    int expected_size = arr_float.extent.size() * sizeof(float) / sizeof(double);
    Log() << "Expected size: " << expected_size << " actual: " << av_double.extent[0] << std::endl;
    if (av_double.extent[0] != expected_size)
    {
        return runall_fail;
    }
